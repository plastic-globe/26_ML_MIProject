...
The processed files under `lib/` are generated artifacts. Build them with:

```bash
python experiments/data_generation/build_lib.py --input-file raw_data/sample_mmlu.jsonl
```
